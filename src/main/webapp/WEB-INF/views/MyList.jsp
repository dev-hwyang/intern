...
<%-- 	<%UserMember user = (UserMember)SecurityContextHolder.getContext().getAuthentication().getPrincipal(); %> --%>
	...
	<div class="container-xxl flex-grow-1 container-p-y">
		<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">메뉴 /</span> 내가 작성한 게시글 보기</h4>
		...
		<div class="card">
			<form id="searchForm">
				<div class="row">
				<h5 class="card-header col-md-8">게시글 목록</h5>
				...
				<table class="table">
					...
					<tbody class="table-border-bottom-0">
						<c:if test="${empty list }">
							<tr>
								<th style="text-align: center; font-size: medium;" colspan="6">작성한 게시글이 없습니다.</th>
							</tr>
						</c:if>
						<c:forEach items="${list }" var="list">
							<tr>
								...
								<td style="justify-content: center;"><span class="badge bg-label-info me-1" onclick="location.href='/intern/update?boNo=${list.boNo }'" style="cursor: pointer;">수정하기</span></td>
