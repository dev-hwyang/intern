...
<title>양혜원 인턴 게시판 CRUD 과제</title>
		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="/intern/list" class="app-brand-link">
					...
					<span class="app-brand-text demo menu-text fw-bolder ms-2">board crud</span>
					</a>
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-header small text-uppercase"><span
						class="menu-header-text">양혜원 인턴 과제입니다</span></li>
					<!-- Forms -->
					<li class="menu-item open active">
					  <a href="javascript:void(0);" class="menu-link menu-toggle">
							<i class="menu-icon tf-icons bx bx-detail"></i>
							<div data-i18n="Form Elements">메뉴</div>
					</a>
						<ul class="menu-sub">
							<li class="menu-item">
								<a href="/intern/list" class="menu-link">
									<div data-i18n="Basic Inputs">게시판 목록</div>
								</a>
							</li>
							<li class="menu-item">
								<a href="/intern/register" class="menu-link">
									<div data-i18n="Input groups">게시판 등록</div>
								</a>
							</li>
							<li class="menu-item">
								<a href="/intern/myList" class="menu-link">
									<div data-i18n="Input groups">내가 작성한 게시글</div>
								</a>
							</li>
							<sec:authorize access="hasRole('ROLE_ADMIN')">
								<li class="menu-item">
									<a href="/memberListForAdmin" class="menu-link">
										<div data-i18n="Input groups">회원보기</div>
									</a>
								</li>
							</sec:authorize>
						</ul>
