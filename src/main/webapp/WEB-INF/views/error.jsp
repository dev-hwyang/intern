...
<body>
	...
	<!-- Content -->
	<div class="authentication-wrapper authentication-basic container-p-y col-md-4" style="position: relative; margin: auto;">
		<div class="authentication-inner">
			...
			<div class="card-body">
				...
				<!-- /Logo -->
				<h4 class="my-2" style="text-align: center;">❌ 에러 발생 ❌</h4>
